...
pub struct LoginConfig {
    ...
    pub geo_db_path: GeoDbPathSetting,
    pub allow_plaintext_passwords: AllowPlaintextPasswordsSetting,
...
mod tests {
    ...
    fn test_defaults() {
        ...
        assert!(login.geo_db_path.is_set_to_default());
        assert!(login.allow_plaintext_passwords.is_set_to_default());
